...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _registerServiceWorker = __webpack_require__(216);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _About = __webpack_require__(210);
	...
	var _Location = __webpack_require__(212);

	var _Location2 = _interopRequireDefault(_Location);

	var _Locations = __webpack_require__(213);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Locations = function (_Component) {
	  ...
	  function Locations() {
	    ...
	    var _this = _possibleConstructorReturn(this, (Locations.__proto__ || Object.getPrototypeOf(Locations)).call(this));
	  ...
	  _createClass(Locations, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      fetch('/api/v1.0/sceniclocations').then(function (results) {
	        ...
	        _this2.setState({ locations: data.sceniclocations });
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      if (this.state.navigate) {
	        ...
	        return _react2.default.createElement(_reactRouterDom.Redirect, { to: { pathname: this.state.navigateTo, state: { selectedLocation: this.state.selectedLocation } }, push: true });
	      }

	      var locationComponents = [];
	      if (this.state.locations !== undefined) {
	        locationComponents = this.state.locations.map(function (location) {
	          return _react2.default.createElement(
	            'li',
